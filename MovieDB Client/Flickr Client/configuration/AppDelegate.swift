...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        let nowPlayingController = nowPlayingNavigationController.topViewController as! FilmListController
        nowPlayingController.tabType = FilmListController.TabType.NOW_PLAYING
        ...
        let topRatedController = topRatedNavigationController.topViewController as! FilmListController
        topRatedController.tabType = FilmListController.TabType.TOP_RATED
